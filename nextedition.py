...
def extract_text_exclude_child(outerHTML, child_selector):
    """
    자식을 제외한 text 추출
    """
...
for item in items:
    ...
    detail_box = infomation_card.find_elements(By.CSS_SELECTOR, ".list-inline li")

    genre = extract_text_exclude_child(detail_box[0].get_attribute("outerHTML"), "span")
    recomended_number_of_people = extract_text_exclude_child(
